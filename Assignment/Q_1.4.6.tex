...
\end{align}
\begin{align}
&\implies\angle{BOC}=\cos^{-1}\brak{\frac{-4270}{4514}}=161.07536^{\degree}\\
\end{align}
...
\end{align}
Therefore $\angle{BAC}=99.46232^{\degree}$.\\
As we can see,$$2\times\angle{BAC}=198.92464^{\degree} $$\\Therefore, $$\angle{BOC}=2\times\angle{BAC}$$\\
Hence,verified.
